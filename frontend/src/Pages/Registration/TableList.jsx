...
const ReserveTable = () => {
  ...
  const getDate = () => {
    ...
    if (user) {
    if (date === "January 1 " + selection.date.getUTCFullYear() ) {console.log("New Years"); }
    else if (date === "July 4 " + selection.date.getUTCFullYear()) { console.log("Independence Day"); }
    else if (date === "November 11 " + selection.date.getUTCFullYear()) { console.log("Veterans Day"); }
    else if (date === "December 25 " + selection.date.getUTCFullYear()) { console.log("Christmas Day"); }
    else if (date === "January 16 " + selection.date.getUTCFullYear()) { console.log("MLK Day"); }
    else if (date === "May 29 " + selection.date.getUTCFullYear()) { console.log("Memorial Day"); }
    else if (date === "September 4 " + selection.date.getUTCFullYear()) { console.log("Labor Day"); }
    else if (date === "October 9 " + selection.date.getUTCFullYear()) { console.log("Columbus Day"); }
    else if (date === "November 24 " + selection.date.getUTCFullYear()) { console.log("Thanksgiving Day"); }
    }
